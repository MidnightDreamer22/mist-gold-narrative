                ...
                <section>
                  ...
                  <div className="grid md:grid-cols-3 gap-4">
                    ...
                    >
                      ...
                      <p className="text-xs text-gold-400 mt-2">✉️ Confirmation within 1 hour</p>
                    </button>
                  ...
                  {/* Expanded Form */}
                  {expandedOption === 'form' && (
                    <form onSubmit={handleSubmit} className="mt-6 p-6 bg-ink-700 !bg-opacity-100 rounded-lg border border-gold-400/30 space-y-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <Textarea
                          ...
                          placeholder="Celebrating something? Dietary restrictions? Let us know..."
                        />
                      </div>
